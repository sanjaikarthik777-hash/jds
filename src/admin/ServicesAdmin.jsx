  ...
  return (
    <div>
      ...
      <div style={styles.grid}>
          ...
          <div key={product.id} style={styles.card}>
            <div style={styles.cardHeader}>
              ...
              <div style={styles.actions}>
                <button onClick={() => openModal(product)} style={styles.iconBtn}><Edit2 size={16} /></button>
                <button onClick={() => handleDelete(product.id)} style={{ ...styles.iconBtn, color: '#ef4444' }}><Trash2 size={16} /></button>
              </div>
            </div>
        ...
        {products.length === 0 && <p style={{ color: '#94a3b8' }}>No products added yet.</p>}
      </div>
        ...
        <div style={styles.modalOverlay}>
          <div style={styles.modal}>
            <div style={styles.modalHeader}>
              <h3 style={{ color: '#fff', margin: 0 }}>{editingId ? 'Edit Product' : 'Add New Product'}</h3>
...
const styles = {
  ...
  badge: { background: 'rgba(0, 242, 255, 0.15)', color: 'var(--accent-primary)', padding: '0.2rem 0.6rem', borderRadius: '4px', fontSize: '0.8rem', fontWeight: '600' },
